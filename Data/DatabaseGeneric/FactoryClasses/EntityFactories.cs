...
namespace Demo.FactoryClasses
{
	...
	{
		private readonly Demo.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, Demo.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((Demo.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public RoleEntityFactory() : base("RoleEntity", Demo.EntityType.RoleEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", Demo.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserRoleEntityFactory() : base("UserRoleEntity", Demo.EntityType.UserRoleEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(Demo.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(Demo.EntityType)))
			{
				var factory = GetFactory((Demo.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the Demo.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(Demo.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case Demo.EntityType.RoleEntity:
					return new RoleEntityFactory();
				case Demo.EntityType.UserEntity:
					return new UserEntityFactory();
				case Demo.EntityType.UserRoleEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the Demo.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (Demo.EntityType)Enum.Parse(typeof(Demo.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((Demo.EntityType)Enum.Parse(typeof(Demo.EntityType), leftOperandEntityName, false), joinType, (Demo.EntityType)Enum.Parse(typeof(Demo.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (Demo.EntityType)Enum.Parse(typeof(Demo.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((Demo.EntityType)entityTypeValue); }
